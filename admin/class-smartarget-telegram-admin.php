 ...
 */
class SmartargetTelegram_Admin {
	...
	public function add_plugin_admin_menu() {
		...
		*/
		add_options_page( 'Smartarget Telegram - Contact Us Settings', 'Smartarget Telegram - Contact Us', 'manage_options', $this -> plugin_name, array($this, 'display_plugin_setup_page'));
	}
	...
	public function display_plugin_setup_page() {
		...
		include_once( 'partials/smartarget-telegram-admin-display.php' );
	}
